...
class TrendExportService {
  ...
  static String _generateTextSummary(List<TrendDataPoint> trendData) {
    ...
    return '''
📊 Vital Signs Trends Summary

⏱️ Duration: $minutes minutes
📅 ${DateFormat('MMM dd, yyyy HH:mm').format(trendData.last.timestamp)}

❤️ Heart Rate:
  • Average: ${avgHR.toStringAsFixed(1)} BPM
  • Min: ${minHR.toStringAsFixed(1)} BPM
  • Max: ${maxHR.toStringAsFixed(1)} BPM

🫁 Breathing Rate:
  • Average: ${avgBR.toStringAsFixed(1)} breaths/min
  • Min: ${minBR.toStringAsFixed(1)} breaths/min
  • Max: ${maxBR.toStringAsFixed(1)} breaths/min
